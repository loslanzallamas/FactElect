...
<body>
<div style="border:1px solid black; padding: 15px; background-color:aqua;">
	<h3>Comprobantes</h3>
	<table border="1">
	...
	<table>
		<tr>
			<th>${feCompConsResponse.docNro}</th>
			<th>${feCompConsResponse.codAutorizacion}</th>
			<th>${feCompConsResponse.fchVto}</th>
		</tr>
	</table>
	</div>
	<a href="\\fpm-2k3srvr\Tractoagro\Tracto\modelo.pdf">Modelo de documento para impresión</a>
</body>
</html>